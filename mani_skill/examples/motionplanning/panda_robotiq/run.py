...
def parse_args(args=None):
    ...
    parser.add_argument("-e", "--env-id", type=str, default="PutCarrotOnPlateInScene-v1", help=f"Environment to run motion planning solver on. Available options are {list(MP_SOLUTIONS.keys())}")
